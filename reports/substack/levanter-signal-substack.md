<!-- ─────────────────────────────────────────────────────────────
EDITOR NOTE. Delete this block before publishing.

1. Merged from the corrected week-of-24-August PDF (captured 10:16 GST,
   25 August). Model naming, the cycle-gauge paragraph and the retitled
   chart all match the regenerated source.

2. CHART: use X20_final_trim.png, the retitled one. Its title now reads
   "Bitcoin vs the valuation fit" with a "Fit floor (5th percentile)"
   legend. Earlier trims of this chart carry the old adoption wording.

3. SUBSTACK SETUP. Publish this into a section called "The Levanter Signal"
   rather than as a loose post. Sections carry their own subscribe setting,
   so when the paid tier switches on, the section flips and the people who
   opted into it are already there.

4. There is no Editor's read in this issue. If you supply one via the
   --editor flag, it goes at the top, above "The one chart", and I will
   add a carousel slide for it.
───────────────────────────────────────────────────────────────── -->

# The Levanter Signal, week of 24 August 2026
...
![Bitcoin against its long-run trend](CHART-UPLOAD-HERE: use X20_final_trim.png)
...
*This is the Levanter Signal, the weekly subscriber note, free for now while we build the list. We will tell you before that changes. Subscribe at [read.levantermarkets.com](https://read.levantermarkets.com). The daily, weekly and monthly reviews stay free at [levantermarkets.com](https://levantermarkets.com).*
